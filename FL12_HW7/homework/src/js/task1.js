...
const NUM5 = 5, NUM6 = 6;
if ( !(email = prompt('Input your email') ) || !email.trim() ) {
	alert('Canceled');
} else if (email.length < NUM5) {
	alert('I don\'t know any emails having name length less than 5 symbols');
} else if (email !== 'user@gmail.com' && email !== 'admin@gmail.com') {
	alert('I don\'t know you');
} else if ( !(pass = prompt('Input your password') ) || !pass.trim() ) {
	alert('Canceled');
...
} else if ( !(oldPass = prompt('Input your old password') ) || !oldPass.trim() ) {
	alert('Canceled');
} else if (oldPass !== pass) {
	alert('Wrong old password');
} else if ( !(newPass = prompt('Input your new password') ) || !newPass.trim() ) {
	alert('Canceled');
